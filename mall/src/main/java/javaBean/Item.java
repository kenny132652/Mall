...
public class Item {
	...
	public Item(int itemId, String itemName, byte[] itemPhoto, int itemPrice, Timestamp itemDate,
	...
	public Item(String itemName, byte[] itemPhoto, int itemPrice, Timestamp itemDate, String itemLocation,
